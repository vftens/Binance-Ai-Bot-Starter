...
from cython_cppwraper.tradingrrl import TradingRRL

class NeuralRRL(object):
    """
    Base class for neural network with RRL 

    """
    def __init__(self):
        pass

    def mainrrl(self, init_t = 6000, T = 1000, M = 200, mu = 10000, sigma = 0.04, rho = 1.0, n_epoch = 10000):
